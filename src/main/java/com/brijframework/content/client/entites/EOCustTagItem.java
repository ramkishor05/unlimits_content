...
import static com.brijframework.content.constants.Constants.EOCUST_TAG_ITEM;
...
@Table(name = EOCUST_TAG_ITEM, uniqueConstraints = {
		@UniqueConstraint(columnNames = { CUST_BUSINESS_APP_ID, GROUP_ID, NAME }) })
public class EOCustTagItem extends EOCustItem {
	/**
	 * 
	 */
