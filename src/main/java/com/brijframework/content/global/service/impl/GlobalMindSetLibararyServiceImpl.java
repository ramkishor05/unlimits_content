...
public class GlobalMindSetLibararyServiceImpl extends CrudServiceImpl<UIGlobalMindSetLibarary, EOGlobalMindSetLibarary, Long> implements GlobalMindSetLibararyService {
	...
	@Override
	public void preAdd(UIGlobalMindSetLibarary data, Map<String, List<String>> headers, Map<String, Object> filters,
	...
	@Override
	public void preAdd(UIGlobalMindSetLibarary data, EOGlobalMindSetLibarary entity,
			Map<String, List<String>> headers, Map<String, Object> filters, Map<String, Object> actions) {
		saveResource(data, entity);
	}

	@Override
	public void preUpdate(UIGlobalMindSetLibarary data, EOGlobalMindSetLibarary find,
			Map<String, List<String>> headers, Map<String, Object> filters, Map<String, Object> actions) {
	...
	public Boolean deleteById(Long id) {
		...
		if (findById.isPresent()) {
			EOGlobalMindSetLibarary eoGlobalReprogramLibarary = findById.get();
	...
	protected void saveItems(UIGlobalMindSetLibarary data, EOGlobalMindSetLibarary entity, Map<String, Object> actions) {
